export const exchangeContractAddress =
  '0xe41e91605f42a24cd59dDC3E4CDe1b5511944F93'
export const exchangeContractAbi = [
  {
    inputs: [
      { internalType: 'address', name: '_nftAddress', type: 'address' },
      { internalType: 'address', name: '_quoteErc20Address', type: 'address' },
    ...
    outputs: [
      {
        ...
        internalType: 'struct CyberDAOMarket.AskEntry[]',
        name: '',
        type: 'tuple[]',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct CyberDAOMarket.BidEntry[]',
        name: '',
        type: 'tuple[]',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct CyberDAOMarket.UserBidEntry[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: '_feeAddr', type: 'address' }],
